...
/**Deck uses deck API, allows draing one card at a time */
...
function Deck() {
    ...
    /**draw card: change state and effect will execute */
    async function draw() {
        try {
    ...
    /** return draw button (this is disabled if shuffling) */
    ...
    /**return shuffle button (disabled if alreaddy returned) */
